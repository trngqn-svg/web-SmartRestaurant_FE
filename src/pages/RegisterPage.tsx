          ...
          <div className="max-w-[340px] mx-auto w-full">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="space-y-1">
                <label className="text-[13px] font-bold text-slate-500 tracking-wider ml-1">Full Name</label>
                <input
              ...
              {/* Email */}
              <div className="space-y-1">
                <label className="text-[13px] font-bold text-slate-500 tracking-wider ml-1">Email</label>
                <input
                  type="email"
                  {...register("email", { 
              ...
              {/* Confirm Password */}
              <div className="space-y-1">
                <label className="text-[13px] font-bold text-slate-500 uppercase tracking-wider ml-1">Confirm Password</label>
                <input
                  type="password"
              ...
              <div>
                ...
                <div className="flex items-center gap-4 py-2">
                  ...
                  <div className="text-[10px] font-bold text-slate-300 uppercase tracking-widest">OR</div>
                  <div className="h-px flex-1 bg-slate-100" />
                </div>
